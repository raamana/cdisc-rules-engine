...
class TestPathValidator:
    ...
    def test_validate_read_path_traversal_detected(self):
        ...
        assert "relative paths" in str(exc_info.value).lower() or "traversal" in str(exc_info.value).lower()
    ...
    def test_is_system_directory_windows(self, monkeypatch):
        ...
        test_path = PathLib("C:/Windows/System32")
        assert validator._is_system_directory(test_path)
        
        # Test non-system directories
        assert not validator._is_system_directory(PathLib("C:/Users/test"))
        assert not validator._is_system_directory(PathLib("C:/temp/test"))
